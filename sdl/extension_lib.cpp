...
int main(int argc, char* argv[]) {
    ...
    SDL_Texture *background = loadTexture(resPath + "background_png.png", renderer);
    SDL_Texture *image = loadTexture(resPath + "image_trans.png", renderer);
    ...
    for (int i = 0; i < 3; ++i) {
        ...
        // Draw out image in the center of the window.
